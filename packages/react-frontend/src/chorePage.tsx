...
// import AddOverlay from "./components/homeAddOverlay";
...
// 					handleRemoveClick={(item: string) => handleRemoveChore(item)} renderItem={function (_item: string): React.ReactNode {
// 						throw new Error("Function not implemented.");
// 					} } getKey={function (_item: string): string {
// 						throw new Error("Function not implemented.");
// 					} }				/>
// 			</div>
// 		</div>
